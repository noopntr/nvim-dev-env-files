...
If you are coming from my full neovim setup video with packer, that config is found here: [Packer Config](https://github.com/noopntr-dev/dev-environment-files/tree/packer-nvim-setup)
